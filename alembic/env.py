"""
Alembic env.py — configured for PayFlow.
Reads DATABASE_URL from .env and uses app.models for autogenerate.
"""
...
# ── Import PayFlow models so Alembic can autogenerate migrations ──────────────
